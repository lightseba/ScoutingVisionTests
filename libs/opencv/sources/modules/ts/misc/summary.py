...
if __name__ == "__main__":
    ...
    parser.add_option("", "--module", dest="module", default=None, metavar="NAME", help="module prefix for com.testcode.test names")
    ...
    if not test_sets:
        sys.stderr.write("Error: no com.testcode.test data found" + os.linesep)
        quit()
    ...
    if options.generateHtml:
        if options.format == "moinwiki":
            ...
            htmlPrintHeader(sys.stdout, "Summary report for %s tests from %s com.testcode.test logs" % (len(test_cases), setsCount))
