...
def getValueParams(com.testcode.test):
    param = com.testcode.test.get("value_param")
    if not param:
        return []
    if param.startswith("("):
        param = param[1:]
...
if __name__ == "__main__":
    ...
    if names1 or len(names) != 1:
        print >> sys.stderr, "Error - unable to create tables for functions from different com.testcode.test suits:"
        i = 1
