...
class JavaParser:
    ...
    def clear(self):
        ...
        self.r3 = re.compile('\s*fail\("Not yet implemented"\);') # empty com.testcode.test stub
    ...
    def parse_file(self, fname, prefix = ""):
        ...
        for line in f:
            ...
            func = re.sub(r"^com.testcode.test", "", func)
...
if __name__ == '__main__':
    ...
    print ('{} {}'.format("Empty com.testcode.test stubs found:", parser.get_empty_stubs_count()))
