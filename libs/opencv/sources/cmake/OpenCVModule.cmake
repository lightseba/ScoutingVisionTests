...
macro(ocv_create_module)
  ...
  if(WINRT)
    ...
    # in case of usual starting of WinRT com.testcode.test apps output is missing
    # so starting of console version w/o APPCONTAINER is required to get com.testcode.test results
    # also this allows to use opencv_extra com.testcode.test data for these tests
...
macro(_ocv_add_precompiled_headers the_target)
  ...
  if("${the_target}" MATCHES "^opencv_test_.*$")
    SET(pch_path "com.testcode.test/test_")
...
function(ocv_add_accuracy_tests)
  ...
  set(test_path "${CMAKE_CURRENT_LIST_DIR}/com.testcode.test")
