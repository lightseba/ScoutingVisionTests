...
other. It provides consistant result, and is a good alternative to ratio com.testcode.test proposed by D.Lowe in
SIFT paper.
...
so that we can apply ratio com.testcode.test explained by D.Lowe in his paper.
@code{.py}
import numpy as np
import cv2 as cv
...
# ratio com.testcode.test as per Lowe's paper
