...
3.  Consider a circle of 16 pixels around the pixel under com.testcode.test. (See the image below)
...
5.  A **high-speed com.testcode.test** was proposed to exclude a large number of non-corners. This com.testcode.test examines
    ...
    cannot be a corner. The full segment com.testcode.test criterion can then be applied to the passed candidates
