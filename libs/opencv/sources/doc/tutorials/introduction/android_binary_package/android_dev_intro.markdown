...
AVD (*Android Virtual Device*) is not probably the most convenient way to com.testcode.test an OpenCV-dependent
...
If you have an Android device, you can use it to com.testcode.test and debug your applications. This way is more
