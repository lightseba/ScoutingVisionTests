...
In this example, we use a minimal com.testcode.test program that loads an image from a file and runs an edge
...
void help()
{
    cout
        << "----------------------------------------------------" << endl
        << "This is a com.testcode.test program for the Image Watch Debugger " << endl
