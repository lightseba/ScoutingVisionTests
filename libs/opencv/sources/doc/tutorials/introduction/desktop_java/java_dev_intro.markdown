...
To com.testcode.test that everything is working, create a simple "Hello OpenCV" application. Do this by creating
a file `src/main/java/com.testcode.HelloOpenCV.java` with the following contents:
@code{.java}
public class com.testcode.HelloOpenCV {
  public static void main(String[] args) {
...
@endcode
Now modify src/main/java/com.testcode.HelloOpenCV.java so it contains the following Java code:
@code{.java}
import org.opencv.core.Core;
import org.opencv.core.Mat;
